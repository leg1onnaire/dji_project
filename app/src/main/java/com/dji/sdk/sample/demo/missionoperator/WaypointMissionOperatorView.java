...
public class WaypointMissionOperatorView extends MissionBaseView {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.activity_waypoint_mission, this, true);

        wp1Latitude = findViewById(R.id.edittext_wp1_latitude);
        wp1Longitude = findViewById(R.id.edittext_wp1_longitude);
        wp2Latitude = findViewById(R.id.edittext_wp2_latitude);
        wp2Longitude = findViewById(R.id.edittext_wp2_longitude);
        wp3Latitude = findViewById(R.id.edittext_wp3_latitude);
        wp3Longitude = findViewById(R.id.edittext_wp3_longitude);
        wp4Latitude = findViewById(R.id.edittext_wp4_latitude);
        wp4Longitude = findViewById(R.id.edittext_wp4_longitude);
        altitude = findViewById(R.id.edittext_altitude);
        speed = findViewById(R.id.edittext_speed);
    ...
    private void setWaypointMission() {
        try {
            double wp1Lat = Double.parseDouble(wp1Latitude.getText().toString());
            double wp1Lng = Double.parseDouble(wp1Longitude.getText().toString());
            double wp2Lat = Double.parseDouble(wp2Latitude.getText().toString());
            double wp2Lng = Double.parseDouble(wp2Longitude.getText().toString());
            double wp3Lat = Double.parseDouble(wp3Latitude.getText().toString());
            double wp3Lng = Double.parseDouble(wp3Longitude.getText().toString());
            double wp4Lat = Double.parseDouble(wp4Latitude.getText().toString());
            double wp4Lng = Double.parseDouble(wp4Longitude.getText().toString());
            double alt = Double.parseDouble(altitude.getText().toString());
            double spd = Double.parseDouble(speed.getText().toString());

            // Create a waypoint mission with the input values
            WaypointMission.Builder builder = new WaypointMission.Builder();
            builder.autoFlightSpeed((float) spd);
            ...
            Waypoint waypoint1 = new Waypoint(wp1Lat, wp1Lng, (float) alt);
            waypointList.add(waypoint1);
            Waypoint waypoint2 = new Waypoint(wp2Lat, wp2Lng, (float) alt);
            waypointList.add(waypoint2);
            Waypoint waypoint3 = new Waypoint(wp3Lat, wp3Lng, (float) alt);
            waypointList.add(waypoint3);
            Waypoint waypoint4 = new Waypoint(wp4Lat, wp4Lng, (float) alt);
            ...
            ToastUtils.setResultToToast("Please enter valid numbers");
        }
    }
